...
const BOOKS = [
  ...
  },
  {
    ...
    type: 'canto', cantoLabel: 'Canto', urlPrefix: 'sb',
    cantos: {
  ...
  },
  {
    ...
    type: 'canto', cantoLabel: 'Līlā', urlPrefix: 'cc',
    cantos: {
  ...
  },
  {
    ...
    description: '11 Texts', type: 'simple', urlPrefix: 'noi',
...
function getVedabaseUrl(book, cantoNum, chNum, verseNum) {
  if (book.type === 'canto') {
    const lila = book.id === 'cc' ? ['adi','madhya','antya'][cantoNum-1] : cantoNum;
  ...
  if (view === 'home') return (
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #FFF8F0, #FFF0E0)', fontFamily: 'Georgia, serif', paddingBottom: '100px' }}>
      ...
      <div style={{ padding: '0 20px' }}>
        <p style={{ color: '#6B6B6B', fontSize: '14px', margin: '0 0 16px', lineHeight: 1.6 }}>Browse any verse and open it directly on Vedabase.io with full translation and purport.</p>
        {BOOKS.map(book => (
